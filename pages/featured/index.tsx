...
import { Provider, useData, useLoading, useFilter, useSetFilter, useHasNextPage } from '@src/Components/Featured/Provider';
    ...
    <>
      <Row >
        <SearchPageCol span={24}>
          <MainTitle level={1}>Featured</MainTitle>
...
export default nest(Provider, FeaturePage)