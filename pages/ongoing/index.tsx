...
import { Provider, useData, useLoading, useFilter, useSetFilter, useHasNextPage } from '@src/Components/Ongoing/Provider';
    ...
    <>
      <Row >
        <SearchPageCol span={24}>
          <MainTitle level={1}>Ongoing</MainTitle>
...
export default nest(Provider, OngoingPage)