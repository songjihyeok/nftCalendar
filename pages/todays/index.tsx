...
import { Provider, useData, useLoading, useFilter, useSetFilter, useHasNextPage } from '@src/Components/Todays/Provider';
    ...
    <>
      <Row >
        <SearchPageCol span={24}>
          <MainTitle level={1}>Today's</MainTitle>
...
export default nest(Provider, TodaysPage)