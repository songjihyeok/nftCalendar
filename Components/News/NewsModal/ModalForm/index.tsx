...
import { Form, FormProps, FormItemProps, Select, SelectProps } from 'antd';
...
import { useForm, useFileId, useSetFileId, useOnFinish } from '../Provider';
import { useFiles, useSetFiles, useApiUrl, useGetIdfromRepond, Provider } from './Provider';
...
function ModalForm() {
  ...
  const selectedData = useMemo(() => data.find(obj => obj.id === selectedId), [selectedId]);
