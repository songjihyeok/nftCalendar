    ...
    <>
      <EventRow>
        <Col span={24}>
          ...
          >
            ...
            <Row>
              <MainTitleCol span={24}>
                <MainTitle level={3}>{detailData.title}</MainTitle>
              </MainTitleCol>
            </Row>
          ...
          >
            <Row style={{ width: "100%" }}>
              {moreNewsDetail.map((news, index) => {
                return <Col span={24} key={index} onClick={() => onClickNavigate(news.id)}>
                  <SeeMoreParagraph >
                    {news.title}
                  </SeeMoreParagraph>
                </Col>
...
const MainTitleCol = styled(Col)(({ theme }) => {
  return {
    padding: "28px 20px",
